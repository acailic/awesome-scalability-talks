...
export const FlowerIcon: React.FC<IconProps> = ({ color = 'currentColor', size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12 9C12 7 13 5 15 3C17 5 18 7 18 9C18 11 16 12 15 12" stroke={color} strokeWidth="2" strokeLinecap="round"/>
    <path d="M12 15C12 17 13 19 15 21C17 19 18 17 18 15C18 13 16 12 15 12" stroke={color} strokeWidth="2" strokeLinecap="round"/>
    <path d="M12 9C12 7 11 5 9 3C7 5 6 7 6 9C6 11 8 12 9 12" stroke={color} strokeWidth="2" strokeLinecap="round"/>
    <path d="M12 15C12 17 11 19 9 21C7 19 6 17 6 15C6 13 8 12 9 12" stroke={color} strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
